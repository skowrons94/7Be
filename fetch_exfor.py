...
if __name__ == "__main__":
    ...
    for p in lightA.keys():
        ...
        At = Acn - Ap
        Zt = Zcn - Zp
        #if Ap<=At: # FIXME: this is a bug, but it is in the original code
                ...
                for obs in allObs:
                    ...
                    for e in subents:
                        ...
                        for d in ds:
                            ...
                            if datasets is not None and subent not in datasets:
                                print(20*' ',subent,'not in include list')
                                continue
    ...
    #                                   continue
                            ...
                            if E_index is not None:
                                ...
                                #    print( stuff, type(stuff) )
                                    ...
                                    #if type(E) is str: continue
                                    E *= E_scale
                                    emin = min(emin,E)
                                    emax = max(emax,E)
        
                                #for E in ds[d].data.iloc[:,E_index]:
                                #    if E is None: continue
                                #    E *= E_scale
                                #    print( E, type(E) )
                                #    emin = min(emin,E)
